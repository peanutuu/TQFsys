...
@section('content')
    ...
    <div>
        ...
        <table style="width:100%">
                <tr>
                    <th colspan="3"> ชื่อสถาบันอุดมศึกษา</th>
                    <td> มหาวิทยาลัยมหาสารคาม </td>
                </tr>
                <tr>
                    <th colspan="3"> คณะ / สาขาวิชา </th>
                    <td> วิทยาการสารสนเทศ คณะวิทยาการสารสนเทศ </td>
                </tr>
        </table>
        <table style="width:100%">
            <td align="center"> หมวดที่ 1 ข้อมูลโดยทั่วไป </td>
        </table>
        <table style="width:100%">
            <tr>
                <th colspan="1"> 1. รหัสวิชาและชื่อรายวิชา </th>
            ...
            <tr>
                ...
                <th colspan="3"> ชั้นปีที่ {{$tqf3->tqf3152}} </th>
            </tr>
            <tr>
        ...
        <table style="width:100%">
            <tr>
                <td align="center"> หมวดที่ 2 จุดมุ่งหมายและวัตถุประสงค์ </td> 
            </tr>
        </table>
        <table style="width:100%">
            <tr>
        ...
        <table style="width:100%">
            <tr>
                <td align="center"> หมวดที่ 3 ลักษณะและการดำเนินการ </td>
            </tr>
        </table>
        <table style="width:100%">
            <tr>
        ...
        <table style="width:100%">
            <tr>
                <td align="center"> หมวดที่ 4 การพัฒนาการเรียนรู้ของนิสิต </td>
            </tr>
        </table>
        <table style="width:100%">
            <tr>
                <td > 1.คุณธรรม จริยธรรม </td>
            </tr>
            <tr>
            ...
            <tr>
                <td > 4.ทักษะความสัมพันธ์ระหว่างบุคคลและความรับผิดชอบ </td>
            </tr>
            <tr>
            ...
            <tr>
                <td > 5.ทักษะการวิเคราะห์เชิงตัวเลข การสื่อสาร และการใช้เทคโนโลยีสารสนเทศที่ต้องพัฒนา </td>
            </tr>
            <tr>
            ...
            <table style="width:100%">
                <tr>
                    <td align="center"> หมวดที่ 5 แผนการสอนและการประเมินผล </td>
                </tr>
            </table>
            <table style="width:100%">
                <tr>
                ...
                <tr>
                    <th colspan="4"> 2.แผนการประเมินผลการเรียนรู้
            ...
            <table style="width:100%">
                <tr>
                    <td align="center"> หมวดที่ 6 ทรัพยากรประกอบการเรียนการสอน </td>
                </tr>
            </table>
            <table style="width:100%">
                <tr>
            ...
            <table style="width:100%">
                <tr>
                    <td align="center"> หมวดที่ 7 การประเมินและปรับปรุงการดำเนินการของรายวิชา </td>
                </tr>
            </table>
            <table style="width:100%">
                <tr>
