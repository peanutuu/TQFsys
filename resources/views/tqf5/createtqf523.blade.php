<html>
    <head>
        ...
        <title>สร้างตารางประสิทธิผลของวิธีสอนที่ทำให้เกิดผลการเรียนรู้ตามที่ระบุในรายละเอียดของรายวิชา</title>
 ...
 <body>
  ...
  <div>    
     <br />
     <h3 align="center">สร้างตารางประสิทธิผลของวิธีสอนที่ทำให้เกิดผลการเรียนรู้ตามที่ระบุในรายละเอียดของรายวิชา มคอ.5ของรายวิชา {{$tqf5->subject->subjectid}}</h3>
     <br />
        ...
        <form method="post" id="dynamic_form">
            <span id="result"></span>
                <table class="table table-bordered table-striped" id="user_table">
                    <thead>
                        <tr>
                            <th width="25%" rowspan="2"> ผลการเรียนรู้ </th>
                            <th width="25%" rowspan="2"> วิธีสอนที่ระบุในรายละเอียด รายวิชา </th>
                            <th width="25%" rowspan="2"> ประสิทธิผล </th>
                            <th width="25%" rowspan="2"> ปัญหาของการใช้วิธีสอน (ถ้ามี) พร้อมข้อเสนอแนะในการแก้ไข</th>
                        </tr>
                    </thead>
                        <tbody id="t1">
...
$(document).ready(function()
    {
        ...
        {
            html = '<tr>';
            html += '<td><textarea name="tqf5231[]" rows="5" cols="4" class="form-control" ></textarea></td>';
            html += '<td><textarea name="tqf5232[]" rows="5" cols="4" class="form-control" ></textarea></td>';
            html += '<td><select name="tqf5233[]" class="form-control" >><option disable >เลือก</option><option value="มี">มี</option><option value="ไม่มี">ไม่มี</option></select>  </td>';
            html += '<td><textarea name="tqf5234[]" rows="5" cols="4" class="form-control" ></textarea></td>';
